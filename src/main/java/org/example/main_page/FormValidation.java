...
public class FormValidation {
    ...
    public static class XValidator implements Validator<Integer> {
        ...
        @Override
        public void validate(FacesContext facesContext, UIComponent uiComponent, Integer o) throws ValidatorException {
            if (o == null) {
            ...
            try {
                if (o > 5 || o < -3) {
                    FacesMessage msg = new FacesMessage("X не входит в ОДЗ: [-3, 5]");
                    msg.setSeverity(FacesMessage.SEVERITY_ERROR);
                    throw new ValidatorException(msg);
                }
